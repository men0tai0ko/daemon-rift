...
### v0.5.2（2026-05-05）
- 深度帯ごとの探索BGM切り替えを実装（`AUDIO.playBgmExplore`）
  - 廃都表層（F1-10）: のこぎり波 [55, 82.4, 110Hz]（従来通り）
  - 地下街区（F11-30）: トライアングル波 [41.2, 61.7, 82.4Hz]
  - 冥界回廊（F31-60）: スクエア波 [36.7, 55, 73.4Hz]
  - 虚無の底（F61+）: サイン波 [27.5, 41.2, 55Hz]・超低速LFO
